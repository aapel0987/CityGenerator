...
public class BasicMapConstructor extends Constructor {
	...
	public Group createSimpleMap(Area routeableArea){
		...
		BasicRoadConstructor stoneRoadConstructor = new BasicRoadConstructor(2,MaterialsCollection.Stone);
		map.add("large_roads", stoneRoadConstructor.construct(mapBase, map));
